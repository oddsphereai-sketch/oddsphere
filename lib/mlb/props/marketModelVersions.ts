...
export const MLB_PROPS_MODEL_RELEASE_ID = "mlb_props_2026_07_26_r9";
...
const DEDICATED_MARKET_MODEL_VERSIONS: Partial<Record<MlbPropMarketKey, string>> = {
  ...
  batter_hits: `${BATTER_HITS_PA_MODEL_VERSION}_actionability_v2`,
  batter_hits_runs_rbis: `${BATTER_HRR_MODEL_VERSION}_actionability_v2`,
  batter_total_bases: "batter_total_bases_event_distribution_integrated_read_v2_calibrated",
  batter_home_runs: "batter_home_runs_rare_event_integrated_read_v6_ranked_lean_sleeve",
