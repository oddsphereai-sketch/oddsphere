...
export const MLB_PROPS_MODEL_RELEASE_ID = "mlb_props_2026_08_12_r31";
...
const DEDICATED_MARKET_MODEL_VERSIONS: Partial<Record<MlbPropMarketKey, string>> = {
  ...
  batter_home_runs: `${BATTER_HOME_RUNS_RESIDUAL_MODEL_VERSION}_actionability_v2_over_promotion_removed`,
