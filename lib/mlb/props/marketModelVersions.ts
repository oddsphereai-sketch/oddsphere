...
export const MLB_PROPS_MODEL_RELEASE_ID = "mlb_props_2026_07_28_r15";
...
const DEDICATED_MARKET_MODEL_VERSIONS: Partial<Record<MlbPropMarketKey, string>> = {
  ...
  batter_home_runs: "batter_home_runs_rare_event_integrated_read_v10_consensus_best_price_lean_path",
