 ...
 * categories (CBB). Adding a market to an empty array
...
> = {
  ...
  // UCL persists under sport="soccer" and the exact competition key, but the
  // legacy UCL display key carries the same four regulation-time markets.
  ucl: ["match_result", "total", "btts", "double_chance"],
