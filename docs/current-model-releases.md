...
### Injury pagination and Player Props recovery (r15)
...
- September 16 current-season input and ranked-prediction correction: active model / calibration / decision / runtime / board / member / writer / tracking are `nfl_player_props_distribution_model_2026_09_16_r9_current_season_inputs` / `nfl_player_props_distribution_calibration_2026_09_16_r9_ranked_predictions` / `nfl_player_props_decision_2026_09_16_r12_ranked_predictions` / `nfl_player_props_runtime_2026_09_16_r13_current_season_inputs` / `nfl_player_props_board_2026_09_16_r16_ranked_predictions` / `nfl_player_props_member_2026_09_16_r19_ranked_predictions` / `nfl_player_props_writer_2026_09_16_r22_current_season_inputs` / `nfl_player_props_tracking_2026_09_16_r12_current_season_inputs`; bounded current-season state is `nfl_player_props_current_season_state_2026_09_16_r1_prior_final_games`. The scorer now incorporates completed prior 2026 games instead of retaining rolling inputs frozen through 2025. Displayed Over/Under and scorer predictions use probability-ranked expected-prevalence cohorts computed from the complete slate; probabilities, prices, EV, grades, actionability, stakes, locks, tracking eligibility, and the sole-writer lease are unchanged. Week 1 non-TD replay improves 543-540 (50.14%) to 567-516 (52.35%); the final Week 2 no-write replay covers all 16 games/447 feature rows and produces 72 Yes-TD predictions plus materially separated Over/Under cohorts. No member copy or label is added. Evidence and rollback: `docs/model-audits/2026-09-16-nfl-player-props-current-season-ranked-predictions-predeclaration.md` and `docs/model-audits/2026-09-16-nfl-player-props-current-season-ranked-predictions-result.md`.
