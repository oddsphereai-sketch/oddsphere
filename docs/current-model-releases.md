...
- Writer/releases: evidence schema / collector remain `nfl_forward_evidence_snapshot_2026_08_31_r4_weekly_market_injury` / `nfl_forward_evidence_collector_2026_08_31_r4_weekly_market_injury`; the single authoritative leased writer is `nfl_forward_evidence_writer_2026_08_31_r17_cross_release_odds_history`, and the compact member snapshot is `nfl_forward_member_snapshot_2026_08_31_r4_cross_release_odds_history`. The store reads r4/r3/r2/r1 with bounded 1,000-row pagination and a 5,000-row per-release cap. The member fixture `nfl_weekly_member_fixture_2026_08_31_r13_cross_release_odds_history` selects predictions and exact-price decisions only from current r4, while reconstructing each same-book movement trail from all compatible immutable r4/r3/r2/r1 observations. This repairs the release-boundary defect that hid already-stored NFL movement after the r4 transition; it changes no forecast, side, probability, grade, stake, lock, or tracking tuple. Writer r17 contains a malformed game at game scope, preserves one `prediction_pipeline:nfl` lease, one append path and immutable T-60 priority, and retains strict named-book split provenance. A fragmented exact-line board may use one target-excluded same-line comparator to keep a complete conservative prediction tuple, but it cannot receive an actionable grade unless at least two target-excluded same-line comparators exist.
...
- Active releases: model `nfl_player_props_distribution_model_2026_08_25_r2_shared_context`; calibration `nfl_player_props_distribution_calibration_2026_08_25_r2_shared_context`; provider observation `nfl_player_props_provider_observation_2026_08_31_r5_bounded_offset_pagination`; decision `nfl_player_props_decision_2026_08_31_r4_complete_exact_board`; runtime `nfl_player_props_runtime_2026_08_31_r4_complete_exact_board`; board DTO `nfl_player_props_board_2026_08_31_r7_complete_exact_board`; member snapshot `nfl_player_props_member_2026_08_31_r10_complete_exact_board`; writer `nfl_player_props_writer_2026_08_31_r11_complete_exact_board`; tracking `nfl_player_props_tracking_2026_08_31_r5_closing_before_settlement`; settlement `nfl_player_props_settlement_2026_08_25_r3_bounded_finality`. The frozen model/calibration artifact remains checksum provenance at r2; the behavior-bearing exact-board scorer and decision identifiers are r4.
...
- Exact-price policy: every visible read requires a complete target-book line/side price. Watchlist, Lean, and Best Angle additionally require at least one separate same-line book for a target-excluded market benchmark; a complete one-book exact offer remains visible as explicit No Play with current-book no-vig context until independent confirmation exists. Game-level split feeds are not a props dependency and their absence never Holds a prop; the sport-owned market evidence is player projection/participation and injury context plus multi-book price and same-book opening/current/closing movement. Stale, incomplete, and missing-feature outcomes remain unavailable diagnostics. Held is reserved for genuine timestamped role/player-identity ambiguity.
- Actionable lanes: receiving-yards and receptions Unders may reach Best Angle at at least 8% exact-price EV, 3.5pp independent-market edge, 85% participation, and one independent same-line book. Their intermediate band now uses the already-established universal Lean economics (4% EV, 2pp edge, 70% participation and one independent same-line book), restoring a monotonic Watchlist→Lean→Best Angle ladder without changing the Best Angle threshold. Rushing attempts retains its 2% EV / 1pp Lean. Passing attempts/completions/yards and rushing yards remain No Play; anytime TD remains Watchlist-only. Absolute raw-model/independent-market disagreement above the current 48pp p99 integrity boundary becomes completed No Play, never Held or actionable.
