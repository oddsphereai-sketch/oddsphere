...
- Active September 1 cross-market release: model `nfl_player_props_distribution_model_2026_09_01_r3_active_role`; calibration `nfl_player_props_distribution_calibration_2026_09_01_r3_active_role`; market residual `nfl_player_props_market_residual_calibration_2026_09_01_r5_cross_market_movement`; decision `nfl_player_props_decision_2026_09_01_r6_cross_market_movement`; exact market board `nfl_player_props_exact_market_board_2026_09_01_r2_cross_line_opening`; runtime artifact `nfl_player_props_runtime_2026_09_01_r4_cross_market_movement`; runtime scorer `nfl_player_props_runtime_2026_09_01_r6_cross_market_movement`; board `nfl_player_props_board_2026_09_01_r9_cross_market_movement`; member `nfl_player_props_member_2026_09_01_r12_cross_market_movement`; writer `nfl_player_props_writer_2026_09_01_r14_cross_market_movement`; provider observation `nfl_player_props_provider_observation_2026_08_31_r6_rate_limit_bounded`; tracking `nfl_player_props_tracking_2026_09_01_r6_cross_market_movement`; settlement `nfl_player_props_settlement_2026_08_25_r3_bounded_finality`. Player production/opportunity rolls use prior participating games while participation features retain every roster week; runtime enforces the same position/prior-participation/minimum-role support as training. The locked evaluation improves MAE in all seven volume/yardage markets, including passing yards 102.58→44.90, rushing yards 18.93→12.20, and receiving yards 21.65→15.67.
