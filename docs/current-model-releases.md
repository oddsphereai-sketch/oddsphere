...
- Writer/releases: evidence schema / collector remain `nfl_forward_evidence_snapshot_2026_08_23_r3_member` / `nfl_forward_evidence_collector_2026_08_23_r3_member`; the single authoritative leased writer is `nfl_forward_evidence_writer_2026_08_26_r9_market_scoped_t60`. It remains the only prediction writer under `prediction_pipeline:nfl`; no parallel endpoint or reader-side override exists. Writer r9 changes only T-60 tracking accounting: its proposed/existing counts are derived from the exact coherent markets supplied by the frozen decision bundle, never an assumed three-market multiplier or an unrelated sibling record. The reader refuses stale/mixed decision releases. When an upcoming pre-T60 game's latest row does not contain exactly three current r9 decisions under the current r6 member release, the next natural scheduled cycle performs one provider-backed unlocked refresh for the full slate instead of waiting for the ordinary six-hour cadence or relabeling old quotes. T-60 work retains priority, and completed/no-unlocked slates do not generate release-transition provider calls. Strict NFL SharpAPI rows remain distinct from Playbook public consensus.
...
- Reader/rollback: member fixture `nfl_week_one_member_fixture_2026_08_25_r8_same_book_history` consumes every immutable current-schema capture for the exact evaluated sportsbook instead of discarding all but the latest row. The current 144-row store produces coherent same-book trails on all 48 markets (2-5 compact first/material-change/current observations each); 19 markets contain a real changed price or point line. No price, forecast, grade, stake, writer, or tracking behavior changes; split freshness honors the source-specific six-hour early-week contract rather than a contradictory 75-minute presentation default. `NFL_WEEK_ONE_EVIDENCE_BOARD_ENABLED=true` selects the standard 16-game Week 1 slate/reader; `NFL_DAILY_EDGE_ENABLED` remains the visibility rollback. Incomplete health presents a reasoned public No Play on the Bet-grade axis while the independent outcome forecast remains visible for every exception class. Evaluated bet side/book/price, fair probability, edge, EV, and actionability remain absent; internal recovery remains active. The retired preseason package is never restored and the page never falls back to raw evidence. Disable the publication gates to roll back member visibility; immutable evidence and already-locked official records remain preserved.
- Runtime authority: `lib/services/football/nflV1WeekOneOutcome.ts`, `lib/services/football/nflV1ActionableGradeCandidate.ts`, `lib/services/football/nflForwardEvidenceWriter.ts`, `lib/services/football/nflOfficialTrackingRecord.ts`, `lib/services/football/nflWeekOneHeldMemberFixture.ts`, and `lib/services/football/nflScoreIngestService.ts`.
...
- Active score artifact / model / distribution / probability / representative-score releases: `cfb_v1_joint_score_artifact_2026_08_25_r3_weekly` / `cfb_v1_independent_score_model_2026_08_25_r1` / `cfb_v1_empirical_joint_score_distribution_2026_08_25_r1` / `cfb_v1_joint_market_probability_2026_08_25_r1` / `cfb_v1_central_reachable_score_2026_08_25_r1`. The r3 artifact adds checksum-backed portable pre-2026 team state for 256 FBS/FCS identities and applies the unchanged qualified elastic-net heads plus paired empirical residual distribution to any newly scheduled matchup. The independent head uses leakage-safe, opponent-adjusted rolling CFB football inputs and excludes market line, price, fair probability, splits, and movement. The eight opening-week forecasts remain exact frozen parity anchors.
- Active grade / decision releases: `cfb_v1_composite_grade_policy_2026_08_25_r1` / `cfb_v1_daily_edge_decision_2026_08_27_r8_bounded_sharpapi_pagination` using tuple schema `cfb_v1_exact_price_decision_tuple_2026_08_26_r2_provider_source`. Every evaluated grade uses one named sportsbook/line/price against target-excluded same-line named-book consensus. Moneyline and Total have qualified Best Angle lanes; Spread is capped at Lean. Watchlist is a complete positive tuple below the Lean boundary; No Play is a complete non-positive tuple. Missing identity, price, consensus, PMF, or T-60 health remains an internal operational exception and becomes an explicit member No Play without a fabricated evaluated tuple. The independent outcome forecast always remains visible. There is no quota, forced minimum, maximum, stake sizing, or reader override. Quote completeness is market-scoped, and every evaluated tuple records whether its exact target quote came from BALLDONTLIE or the strict SharpAPI fallback. Coefficients, calibration, thresholds, and stake/tracking rules are unchanged; r8 versions only the bounded complete-event provider read after the first natural r7 wave failed closed before publication.
...
- Current authoritative Week 0 candidate replay remains eight games and 24 markets, with 23 complete exact-price decisions. Writer evidence is **2 Best Angles / 2 Leans / 11 Watchlists / 8 evaluated No Plays / 1 internal unavailable market**; member presentation is **2 Best Angles / 2 Leans / 11 Watchlists / 9 No Plays / 0 Held**. Strict SharpAPI exact-event price recovery promotes SJSU-USC Total from the prior unavailable state to Best Angle (Under 60.5 -110) and Spread to evaluated No Play (USC -38.5 -110). Its Moneyline is the one health-based public No Play because no coherent two-sided target/consensus tuple exists; it has no fabricated evaluated side, sportsbook price, fair probability, edge, EV, actionability, or tracking proposal. Its independent USC winner, probability, expected score, representative score, and same-PMF context remain visible. No previously evaluated side, grade, line, or price changes. Expected team points span 16.08-39.42 (SD 7.26), margins -7.82 to +23.34 (SD 9.68), totals 46.58-58.08 (SD 3.23), and the independent board is four Over/four Under. Decimal expected points are primary; the secondary central reachable score comes from the identical PMF and must preserve winner fidelity and centrality.
...
- Writer and provider boundary: BALLDONTLIE slate `balldontlie_ncaaf_slate_2026_08_26_r2_opened_at`; Sharp price fallback `cfb_sharpapi_named_book_fallback_2026_08_27_r2_bounded_pagination`; evidence schema / collector / member / writer `cfb_forward_evidence_snapshot_2026_08_26_r2_price_provenance` / `cfb_forward_evidence_collector_2026_08_27_r6_bounded_sharpapi_pagination` / `cfb_v1_member_release_2026_08_27_r5_bounded_sharpapi_pagination` / `cfb_forward_evidence_writer_2026_08_27_r7_bounded_sharpapi_pagination`. The append-only table schema is unchanged. One scheduled writer owns the `prediction_pipeline:cfb` lease and captures immutable Opening/T-60 evidence plus bounded unlocked refreshes. BALLDONTLIE remains authoritative for schedule and primary prices; planned games without complete same-line coverage receive bounded, strict exact-event SharpAPI named-book reads before the same sole append. Exact-event odds now follow SharpAPI's documented offset through at most four 200-row pages, still inside the existing 96-request run cap; missing/looping offsets and a fifth page fail closed before any append. Only supported US books may be evaluated targets; other trusted books are consensus-only. Writer r7 counts the exact coherent market set for T-60 tracking rather than a three-market game multiplier. QB collection, fail-closed feature health, portable weekly forecasting, and provider budgets remain unchanged. Same-PMF outlooks remain forecast context when an exact-price tuple is unavailable. Playbook consensus is separate. SharpAPI NCAAF splits, timestamped injuries, confirmed depth/starters, and venue weather remain unavailable and are never fabricated.
...
- Reader/rollback: member fixture `cfb_v1_member_fixture_2026_08_26_r5_price_provenance` and `daily_edge_weekly_reader_lifecycle_2026_08_25_r3_cfb` scope the normal Daily Edge slate/reader to the active weekly window and keep the latest complete release authoritative. The common route, DTO types, reader shell, sport switching, modal behavior, and presentation components remain shared with mature MLB behavior. During transition it serves the prior complete r1/r2/r5 wave until the sole writer atomically appends a complete r2/r5/r8 wave; it never mixes releases. Compact movement remains chronological and same-book. Every internal exception preserves the independent outcome forecast and score context; only its evaluated sportsbook side/price, fair probability, edge, EV, actionability, grade price, and tracking proposal are absent. The shared presentation boundary renders that Bet grade as a reasoned No Play while internal recovery remains active. `CFB_DAILY_EDGE_ENABLED=true` and `CFB_FORWARD_EVIDENCE_ENABLED=true` retain their existing gates. Rollback is decision r7 / evidence r2 / member r4 / writer r6 / fixture r5; immutable evidence and tracking remain release-scoped.
- Runtime authority: `lib/services/football/cfbV1Decision.ts`, `lib/services/football/cfbV1WeeklyForecast.ts`, `lib/services/football/cfbWeeklyWindow.ts`, `lib/services/football/cfbForwardEvidenceWriter.ts`, `lib/services/football/cfbSharpApiOdds.ts`, `lib/services/football/footballMarketScopedTracking.ts`, `lib/services/football/cfbOfficialTrackingRecord.ts`, `lib/services/football/cfbMemberFixture.ts`, and the three versioned JSON model artifacts. Evidence: `docs/model-audits/2026-08-25-cfb-generalized-weekly-engine-predeclaration.md`, `docs/model-audits/2026-08-25-cfb-v1-composite-grade-release.md`, `docs/model-audits/2026-08-26-cfb-sharpapi-price-fallback-r7.md`, and `docs/model-audits/2026-08-26-football-market-scoped-t60-predeclaration.md`.

## NFL Player Props production release

- Active releases: model `nfl_player_props_distribution_model_2026_08_25_r2_shared_context`; calibration `nfl_player_props_distribution_calibration_2026_08_25_r2_shared_context`; decision `nfl_player_props_decision_2026_08_25_r2_exact_price_shared_context`; runtime `nfl_player_props_runtime_2026_08_25_r2_shared_context`; board DTO `nfl_player_props_board_2026_08_27_r4_projection_context`; member snapshot `nfl_player_props_member_2026_08_27_r6_projection_context`; writer `nfl_player_props_writer_2026_08_27_r7_projection_context`; tracking `nfl_player_props_tracking_2026_08_25_r4_regular_t60_shared_context`; settlement `nfl_player_props_settlement_2026_08_25_r3_bounded_finality`.
