...
- NFL tracking record / sole writer are `nfl_official_tracking_record_2026_09_04_r6_complete_prediction_denominators` / `nfl_forward_evidence_writer_2026_09_04_r22_complete_tracking_denominators`. An eligible T-60 payload emits all three immutable forecast markets. A market without a coherent exact-price tuple is stored as a side-bearing Held No Play with null price/market probability/edge/EV, so it counts for prediction accuracy but cannot enter Best Angle, Lean, stake, or ROI. True whole-game health failures remain ineligible.
...
- Active publication set: evidence / collector remain `nfl_forward_evidence_snapshot_2026_09_01_r6_forecast_value_separation` / `nfl_forward_evidence_collector_2026_09_01_r6_forecast_value_separation`; member snapshot `nfl_forward_member_snapshot_2026_09_03_r7_target_excluded_forecast`; sole leased writer `nfl_forward_evidence_writer_2026_09_04_r22_complete_tracking_denominators`; member fixture `nfl_weekly_member_fixture_2026_09_03_r16_target_excluded_forecast`; tracking lifecycle / bundle / tuple boundary / record `nfl_tracking_lifecycle_2026_09_03_r9_target_excluded_forecast` / `nfl_tracking_composite_release_bundle_2026_09_03_r5_target_excluded_forecast` / `nfl_evaluated_tuple_tracking_boundary_2026_09_03_r6_target_excluded_forecast` / `nfl_official_tracking_record_2026_09_04_r6_complete_prediction_denominators`. The weekly slate, quarterback substitution and injury-unavailable behavior, one `prediction_pipeline:nfl` lease, append-only writer, immutable T-60 precedence, settlement, member reader, UI, copy, and zero-stake policy are unchanged.
...
### Holistic confidence with graduated favorite-price ceilings (r56)
...
- Publication set: evidence / member `cfb_forward_evidence_snapshot_2026_09_04_r21_favorite_price_tier_ceiling` / `cfb_v1_member_release_2026_09_04_r33_favorite_price_tier_ceiling`; sole writer `cfb_forward_evidence_writer_2026_09_04_r49_favorite_price_tier_ceiling`; fixture / outcome `cfb_v1_member_fixture_2026_09_04_r47_favorite_price_tier_ceiling` / `cfb_market_sharp_public_outcome_contract_2026_09_04_r47_favorite_price_tier_ceiling`; compact member snapshot `cfb_forward_member_snapshot_2026_09_04_r5_favorite_price_tier_ceiling`; tracking `cfb_official_tracking_record_2026_09_04_r18_favorite_price_tier_ceiling`. Shared validator remains `football_cross_market_coherence_2026_09_04_r7_confidence_execution_status`. The forecast PMF, side, probability, projection, quote, EV, stake, one leased writer, T-60 immutability and provider budget are unchanged. The current identical-input board changes 4 Best Angles / 7 Leans / 5 Watchlists / 5 No Plays to 0 / 8 / 8 / 5: USC -2200, Georgia State -4000 and Miami -3000 become Watchlists; Michigan State -395 becomes a Lean. Evidence and rollback: `docs/model-audits/2026-09-04-cfb-extreme-favorite-confidence-cap-r56-predeclaration.md` and `docs/model-audits/2026-09-04-cfb-extreme-favorite-confidence-cap-r56-result.md`. Roll back to confidence `cfb_holistic_confidence_2026_09_04_r2_price_portable_execution`, decision `cfb_v1_daily_edge_decision_2026_09_04_r29_holistic_confidence`, writer `cfb_forward_evidence_writer_2026_09_04_r48_confidence_execution_coherence`, and their r20/r32/r46/r4/r17 publication family without rewriting immutable records; validator r7 is unchanged.
