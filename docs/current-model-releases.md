...
### Market-dominant, fresh-sharp authority (r43 candidate)

- Owner-authorized production candidate: `cfb_market_sharp_aware_production_2026_08_30_r6_market_dominant_fresh_sharp`, under the Aug. 30 owner amendment in `docs/model-change-safety.md`. The authoritative joint PMF is exactly 25% immutable independent-football mass and 75% canonical current-market mass. A strictly identified Circa split may adjust the market anchor only when it is no more than 120 minutes old, not observed after the writer evaluation, and within 0.5 points of the canonical Spread or Total line. A qualifying money-minus-ticket gap may move the pre-mixture anchor by at most 1.5 home-margin points or 1.5 Total points. Current consensus movement is not separately added because the current line already contains it. Every expected score, reachable score, winner probability, exact-line probability, prediction side, EV, and grade is recomputed from the one PMF; no reader override exists. The separately stored independent PMF is diagnostic baseline provenance only.
- Active model set: score runtime `cfb_v1_joint_score_runtime_2026_08_30_r7_market_dominant_fresh_sharp`; model / distribution / probability / representative score `cfb_v1_market_sharp_score_model_2026_08_30_r5_market_dominant_fresh_sharp` / `cfb_v1_market_sharp_joint_distribution_2026_08_30_r5_market_dominant_fresh_sharp` / `cfb_v1_market_sharp_joint_probability_2026_08_30_r5_market_dominant_fresh_sharp` / `cfb_v1_market_sharp_reachable_score_2026_08_30_r5_market_dominant_fresh_sharp`; calibration `cfb_v1_market_sharp_exact_price_calibration_2026_08_30_r4_market_dominant_fresh_sharp`; grade policy remains `cfb_v1_composite_grade_policy_2026_08_29_r3_transition_coherent`; decision / tuple schema `cfb_v1_daily_edge_decision_2026_08_30_r18_market_dominant_fresh_sharp` / `cfb_v1_exact_price_decision_tuple_2026_08_30_r12_market_dominant_fresh_sharp`; public outcome `cfb_market_sharp_public_outcome_contract_2026_08_30_r32_market_dominant_fresh_sharp`.
- Active publication set: evidence schema / collector / member / writer `cfb_forward_evidence_snapshot_2026_08_30_r14_market_dominant_fresh_sharp` / `cfb_forward_evidence_collector_2026_08_30_r21_market_dominant_fresh_sharp` / `cfb_v1_member_release_2026_08_30_r23_market_dominant_fresh_sharp` / `cfb_forward_evidence_writer_2026_08_30_r28_market_dominant_fresh_sharp`; fixture `cfb_v1_member_fixture_2026_08_30_r30_market_dominant_fresh_sharp`; tracking `cfb_official_tracking_record_2026_08_30_r5_market_dominant_fresh_sharp`; presentation `daily_edge_member_presentation_2026_08_30_r21_cfb_market_dominant_fresh_sharp`. The existing forward-evidence writer remains the sole writer under `prediction_pipeline:cfb` and makes one atomic append only after all covered-game coherence gates pass.
...
- Transition and rollback: r14/r23/r18 becomes readable only as one complete release wave, except that exact valid immutable T-60/started rows from r13/r22/r17 or earlier authority may be carried with their original releases and values. A held legacy T-60 does not satisfy the new lock boundary. Official tracking accepts only exact r14/r23/r18/r6 T-60 payloads for the new era; preceding prediction records remain immutable under their original releases. Mixed releases, stale/future sharp influence, incoherence, missing current price coverage, a writer/reader crash, failed future T-60 creation, or a material public tuple mismatch triggers rollback to r13/r22/r17. Evidence: `docs/model-audits/2026-08-30-cfb-market-dominant-sharp-forecast-predeclaration.md`, the frozen forecast-accuracy audit, and the prior r41/r42 audits.
