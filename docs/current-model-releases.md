...
- Transition and rollback: r14/r23/r19 becomes readable only as one complete release wave, except that exact valid immutable T-60/started rows from the preceding r14/r23/r18 authority or earlier releases may retain their original releases and values. A held legacy T-60 does not satisfy the new lock boundary. Official tracking accepts only exact r14/r23/r19/r7 T-60 payloads for the new era; preceding prediction records remain immutable under their original releases. Mixed releases, stale/future sharp influence, incoherence, missing current price coverage, a writer/reader crash, failed future T-60 creation, or a material public tuple mismatch triggers rollback to r14/r23/r18. Evidence: `docs/model-audits/2026-08-30-cfb-unit-probability-bound-hotfix.md`, `docs/model-audits/2026-08-30-cfb-market-dominant-sharp-forecast-predeclaration.md`, the frozen forecast-accuracy audit, and the prior r41/r42 audits.
