...
### Provisional market/sharp-aware authority (r41)

- Owner-authorized production candidate: `cfb_market_sharp_aware_provisional_2026_08_29_r4_authoritative`, derived without threshold changes from PR #265 candidate `cfb_market_sharp_aware_shadow_2026_08_29_r3_borderline_spread` under the narrow exception in `docs/model-change-safety.md`. The authoritative joint PMF is exactly 75% immutable independent-football mass and 25% canonical market/sharp mass. Strictly matched Circa evidence may move the market anchor by no more than one home-margin point and one total point. Every expected score, reachable score, winner probability, exact-line probability, prediction side, EV, and grade is recomputed from that single PMF; no reader override exists. The separately stored independent PMF is diagnostic baseline provenance only.
- Active model set: score runtime `cfb_v1_joint_score_runtime_2026_08_29_r5_market_sharp_authoritative`; model / distribution / probability / representative score `cfb_v1_market_sharp_score_model_2026_08_29_r3_provisional` / `cfb_v1_market_sharp_joint_distribution_2026_08_29_r3_provisional` / `cfb_v1_market_sharp_joint_probability_2026_08_29_r3_provisional` / `cfb_v1_market_sharp_reachable_score_2026_08_29_r3_provisional`; calibration `cfb_v1_market_sharp_exact_price_calibration_2026_08_29_r2_provisional`; grade policy `cfb_v1_composite_grade_policy_2026_08_29_r2_market_sharp_balanced`; decision / tuple schema `cfb_v1_daily_edge_decision_2026_08_29_r16_market_sharp_authoritative` / `cfb_v1_exact_price_decision_tuple_2026_08_29_r10_market_sharp_authoritative`; public outcome `cfb_market_sharp_public_outcome_contract_2026_08_29_r30_provisional`.
- Active publication set: evidence schema / collector / member / writer `cfb_forward_evidence_snapshot_2026_08_29_r12_market_sharp_authoritative` / `cfb_forward_evidence_collector_2026_08_29_r19_market_sharp_authoritative` / `cfb_v1_member_release_2026_08_29_r21_market_sharp_authoritative` / `cfb_forward_evidence_writer_2026_08_29_r26_market_sharp_authoritative`; fixture `cfb_v1_member_fixture_2026_08_29_r27_market_sharp_authoritative`; tracking `cfb_official_tracking_record_2026_08_29_r3_market_sharp_authoritative`; presentation `daily_edge_member_presentation_2026_08_29_r18_cfb_market_sharp_authoritative`. The existing forward-evidence writer remains the sole writer under `prediction_pipeline:cfb` and makes one atomic append only after all covered-game coherence gates pass.
- Same-board impact: the SELECT-only eight-game FBS replay evaluated 22 exact-price tuples. Preceding grades were **2 Best Angles / 2 Leans / 7 Watchlists / 11 No Plays**; candidate probability grades were **0 / 4 / 7 / 11**; final balanced grades were **0 / 5 / 12 / 5**. Seven promotions (six No Play to nonactionable Watchlist, one Watchlist to Lean), two demotions, zero side changes, and net actionable `+1` were observed. TCU -8.5 at DraftKings -105 is the tested bounded recalibration: Lean at 54.398%, +4.994pp edge, and +6.205% EV. The rule creates no Best Angle and no stake.
- Transition and rollback: r12/r21/r16 becomes readable only as one complete release wave, except that an exact immutable T-60/started row from the immediate r11/r20/r15 authority may be carried with its original release stamps. A future unlocked gap rejects the new partial wave, preventing old snapshots from resurfacing as current. Official tracking accepts only exact r12/r21/r16/r4 T-60 payloads; pre-release T-60 rows remain immutable and release-separated. Missing a canonical market anchor on the provisional FBS board, mixed releases, incoherence, or a crash aborts before append and preserves the preceding coherent reader snapshot. Rollback authority is r11/r20/r15 with fixture r26, public outcome r29, presentation r17, writer r25, grade policy r1, and tracking r2. Evidence: `docs/model-audits/2026-08-29-cfb-market-sharp-aware-r40-predeclaration.md`, `docs/model-audits/2026-08-29-cfb-market-sharp-aware-r40.md`, and `docs/model-audits/2026-08-29-cfb-market-sharp-authoritative-r41.md`.
