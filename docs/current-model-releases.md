...
- Writer and provider boundary: BALLDONTLIE slate `balldontlie_ncaaf_slate_2026_08_26_r2_opened_at`; Sharp price fallback `cfb_sharpapi_named_book_fallback_2026_08_26_r1`; evidence schema / collector / member / writer `cfb_forward_evidence_snapshot_2026_08_26_r2_price_provenance` / `cfb_forward_evidence_collector_2026_08_26_r5_sharpapi_price_fallback` / `cfb_v1_member_release_2026_08_26_r4_price_provenance` / `cfb_forward_evidence_writer_2026_08_26_r6_sharp_prices_market_scoped_t60`. The append-only table schema is unchanged. One scheduled writer owns the `prediction_pipeline:cfb` lease and captures immutable Opening/T-60 evidence plus bounded unlocked refreshes. BALLDONTLIE remains authoritative for schedule and primary prices; planned games without complete same-line coverage receive bounded, strict exact-event SharpAPI named-book reads before the same sole append. Only supported US books may be evaluated targets; other trusted books are consensus-only. Writer r6 counts the exact coherent market set for T-60 tracking rather than a three-market game multiplier. QB collection, fail-closed feature health, portable weekly forecasting, and provider budgets remain unchanged. Same-PMF outlooks remain forecast context when an exact-price tuple is unavailable. Playbook consensus is separate. SharpAPI NCAAF splits, timestamped injuries, confirmed depth/starters, and venue weather remain unavailable and are never fabricated.
