...
- Writer/releases: evidence schema / collector remain `nfl_forward_evidence_snapshot_2026_08_23_r3_member` / `nfl_forward_evidence_collector_2026_08_23_r3_member`; the single authoritative leased writer is `nfl_forward_evidence_writer_2026_08_25_r7_actionable_grades`. It remains the only prediction writer under `prediction_pipeline:nfl`; no parallel endpoint or reader-side override exists. The reader refuses stale/mixed decision releases. Strict NFL SharpAPI rows remain distinct from Playbook public consensus.
...
- Evidence: `docs/model-audits/2026-08-25-nfl-actionable-grades-production-r9.md`, `docs/model-audits/2026-08-25-nfl-actionable-grades-r9.md`, `docs/model-audits/2026-08-25-nfl-projected-qb-context-r11.md`, `docs/model-audits/2026-08-23-nfl-discrete-drive-joint-r10.md`, and `docs/model-audits/2026-08-23-nfl-v1-comprehensive-outcome.md`.
