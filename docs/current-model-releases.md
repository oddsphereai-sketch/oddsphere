...
- Active member release: `nfl_v1_member_release_2026_08_24_r3_grading_tiers`; production model / calibration / decision / grade policy: `nfl_v1_daily_edge_model_2026_08_23_r2` / `nfl_v1_daily_edge_calibration_2026_08_23_r2` / `nfl_v1_daily_edge_decision_2026_08_24_r3_grading_tiers` / `nfl_v1_grade_policy_2026_08_24_r3`.
...
- Grade contract: a complete r6 exact-price moneyline qualifier becomes Lean only when its selected team matches the r10 PMF winner. A healthy bounded r6/r10 direction disagreement or direction-coherent tuple within the frozen -1% EV / -1pp edge boundary becomes non-actionable Watchlist; the public side always remains the r10 winner. A coherent moneyline nonqualifier outside that lane is No Play. Spread and total publish their PMF prediction and exact current tuple as No Play because no separate exact-price action lane passed. Only a genuine identity, quote, quarterback-history, injury, or market-completeness failure becomes Held; projected-but-coherent starter status and unavailable SharpAPI splits remain visible context rather than automatic Holds. No Best Angle or stake is authorized.
- Current same-input board impact: the latest authoritative 16-game replay captured through 2026-08-24T11:06:13.297Z produces seven moneyline Leans, three moneyline Watchlists, and six moneyline No Plays, plus 16 spread and 16 total No Plays: 7 Lean / 3 Watchlist / 38 No Play / 0 Held / 0 Best Angle across 48 markets. The Watchlist release changes zero actionable grades: promotions 0, demotions 0, net actionable change 0. On frozen 2024–25 confirmation, the Watchlist was 103 rows, 59-44, +2.371u, +2.30% ROI, but 2025 was negative and the bootstrap ROI interval crossed zero; it is monitoring only. The 2023-selected Best Angle subgroup was positive in both confirmation seasons but failed its stricter bootstrap gates (84.31% probability positive; ROI interval -5.77% to +18.32%) and is rejected. Existing r6+r10 coherent Leans remain unchanged.
...
- Evidence: `docs/model-audits/2026-08-24-nfl-grading-tiers-r3.md`, `docs/model-audits/2026-08-23-nfl-discrete-drive-joint-r10.md`, `docs/model-audits/2026-08-23-nfl-r6-r10-direction-coherence.md`, `docs/model-audits/2026-08-23-nfl-discrete-drive-joint-r9.md`, and `docs/model-audits/2026-08-23-nfl-v1-comprehensive-outcome.md`.
