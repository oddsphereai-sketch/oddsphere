...
- Active publication set: evidence schema / collector / member remain `cfb_forward_evidence_snapshot_2026_08_30_r14_market_dominant_fresh_sharp` / `cfb_forward_evidence_collector_2026_08_30_r21_market_dominant_fresh_sharp` / `cfb_v1_member_release_2026_08_30_r23_market_dominant_fresh_sharp`; writer / fixture are `cfb_forward_evidence_writer_2026_08_30_r31_unit_probability_bound` / `cfb_v1_member_fixture_2026_08_30_r32_unit_probability_bound`; tracking `cfb_official_tracking_record_2026_08_30_r6_unit_probability_bound`; presentation `daily_edge_member_presentation_2026_08_30_r21_cfb_market_dominant_fresh_sharp`. The existing forward-evidence writer remains the sole writer under `prediction_pipeline:cfb` and makes one atomic append only after all covered-game coherence gates pass.
