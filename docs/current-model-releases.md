...
### Coherent forecast and exact-price value separation (r11)

- Active member release: `nfl_v1_member_release_2026_09_01_r11_forecast_value_separation`; model / calibration / decision / grade policy: `nfl_v1_daily_edge_model_2026_09_01_r8_coherent_underdog_value` / `nfl_v1_daily_edge_calibration_2026_09_01_r8_coherent_value_identity` / `nfl_v1_daily_edge_decision_2026_09_01_r14_forecast_value_separation` / `nfl_v1_grade_policy_2026_09_01_r14_qualified_underdog_value`. The forecast retains the established 75% current-market / 25% football anchor, moves 50% of the trained Spread/Total residual-logit adjustment inside the authoritative score distributions, then applies strictly matched fresh Circa splits, lower-strength public splits, and valid same-book opening-to-current movement before rebuilding the final PMFs. Circa remains primary; public evidence cannot reverse it. Missing/stale splits and invalid or mismatched movement contribute exactly zero and never hold or flatten a projection. Evidence may reverse only a weak core direction when the complete corroborated read or fresh qualifying Circa evidence clears the 2.5pp reversal boundary.
...
- Active outcome set: weekly model / distribution / probability `nfl_v1_weekly_market_anchored_outcome_2026_09_01_r2_coherent_movement` / `nfl_pooled_discrete_residual_distribution_2026_09_01_r2_coherent_movement` / `nfl_v1_weekly_pooled_discrete_probability_2026_09_01_r2_coherent_movement`; market-evidence outcome / representative score `nfl_v1_market_evidence_outcome_2026_09_01_r2_coherent_movement_circa_public` / `nfl_v1_market_evidence_representative_score_2026_09_01_r1_coherent_movement`; Spread / Total heads `nfl_v1_spread_event_contained_2026_09_01_r4_coherent_movement_evidence` / `nfl_v1_total_market_evidence_2026_09_01_r3_coherent_movement_evidence`.
- Active publication set: evidence / collector / member snapshot `nfl_forward_evidence_snapshot_2026_09_01_r6_forecast_value_separation` / `nfl_forward_evidence_collector_2026_09_01_r6_forecast_value_separation` / `nfl_forward_member_snapshot_2026_09_01_r6_forecast_value_separation`; sole leased writer `nfl_forward_evidence_writer_2026_09_01_r20_forecast_value_separation`; member fixture `nfl_weekly_member_fixture_2026_09_01_r15_forecast_value_separation`; tracking lifecycle / bundle / tuple boundary / record `nfl_tracking_lifecycle_2026_09_01_r8_forecast_value_separation` / `nfl_tracking_composite_release_bundle_2026_09_01_r4_forecast_value_separation` / `nfl_evaluated_tuple_tracking_boundary_2026_09_01_r5_forecast_value_separation` / `nfl_official_tracking_record_2026_09_01_r4_forecast_value_separation`. The weekly slate, quarterback substitution and injury-unavailable behavior, one `prediction_pipeline:nfl` lease, append-only writer, immutable T-60 precedence, settlement, member reader, UI, copy, and zero-stake policy are unchanged.
- Read-only frozen Week 1 replay of 16 rows captured at `2026-09-01T16:36:09.845Z`: **5 Best Angles / 8 Leans / 8 Watchlists / 27 No Plays** became **11 / 10 / 7 / 20**. Actionables increased 13→21 with 18 promotions and eight demotions; candidate actionables are Moneyline 8, Spread 8, and Total 5. The frozen wave had zero Moneyline forecast-side changes, four independently qualified sub-50% Moneyline value bets, zero Spread side changes, and one nonactionable Total crossing. All 16 score projections and all 48 probabilities/EVs recomputed with natural fractional precision; the maximum absolute expected team-score movement was 2.738214 points. Circa was missing or stale and therefore contributed zero; public evidence and valid same-book movement remained bounded inputs. A focused synthetic boundary proves fresh qualifying Circa can move an underdog above 50% and flip expected-score direction, predicted winner, and forecast side together; an unqualified underdog remains unselected even when the favorite is No Play.
- Runtime authority: `lib/services/football/nflV1WeekOneOutcome.ts`, `lib/services/football/nflV1ProductionDecision.ts`, `lib/services/football/nflV1ActionableGradeCandidate.ts`, `lib/services/football/nflForwardEvidenceWriter.ts`, `lib/services/football/nflForwardMemberSnapshotStore.ts`, `lib/services/football/nflWeekOneHeldMemberFixture.ts`, `lib/services/football/nflTrackingLifecycle.ts`, and `lib/services/football/nflOfficialTrackingRecord.ts`. Shared movement authority is the already-published `lib/services/football/footballOutcomeMarketMovement.ts`. Evidence: `docs/model-audits/2026-09-01-nfl-coherent-market-evidence-predeclaration.md` and `docs/model-audits/2026-09-01-nfl-coherent-market-evidence-result.md`. Roll back the complete forecast/publication set to the August 31 release below; never reinterpret or replace an existing locked payload.
