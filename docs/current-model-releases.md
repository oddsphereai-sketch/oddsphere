...
### Provisional market/sharp-aware authority and transition stabilization (r42)

- Owner-authorized production candidate: `cfb_market_sharp_aware_provisional_2026_08_29_r5_transition_coherent`, derived from PR #265 candidate `cfb_market_sharp_aware_shadow_2026_08_29_r3_borderline_spread` under the narrow exception and actionable-grade-ladder amendment in `docs/model-change-safety.md`. The authoritative joint PMF remains exactly 75% immutable independent-football mass and 25% canonical market/sharp mass. Strictly matched Circa evidence may move the market anchor by no more than one home-margin point and one total point. Every expected score, reachable score, winner probability, exact-line probability, prediction side, EV, and grade is recomputed from that single PMF; no reader override exists. The separately stored independent PMF is diagnostic baseline provenance only.
- Active model set: score runtime `cfb_v1_joint_score_runtime_2026_08_29_r6_transition_coherent`; model / distribution / probability / representative score `cfb_v1_market_sharp_score_model_2026_08_29_r4_transition_coherent` / `cfb_v1_market_sharp_joint_distribution_2026_08_29_r4_transition_coherent` / `cfb_v1_market_sharp_joint_probability_2026_08_29_r4_transition_coherent` / `cfb_v1_market_sharp_reachable_score_2026_08_29_r4_transition_coherent`; calibration `cfb_v1_market_sharp_exact_price_calibration_2026_08_29_r3_transition_coherent`; grade policy `cfb_v1_composite_grade_policy_2026_08_29_r3_transition_coherent`; decision / tuple schema `cfb_v1_daily_edge_decision_2026_08_29_r17_transition_coherent` / `cfb_v1_exact_price_decision_tuple_2026_08_29_r11_transition_coherent`; public outcome `cfb_market_sharp_public_outcome_contract_2026_08_29_r31_transition_coherent`.
- Active publication set: evidence schema / collector / member / writer `cfb_forward_evidence_snapshot_2026_08_29_r13_transition_coherent` / `cfb_forward_evidence_collector_2026_08_29_r20_transition_coherent` / `cfb_v1_member_release_2026_08_29_r22_transition_coherent` / `cfb_forward_evidence_writer_2026_08_29_r27_transition_coherent`; fixture `cfb_v1_member_fixture_2026_08_29_r29_concise_member_read`; tracking `cfb_official_tracking_record_2026_08_29_r4_transition_coherent`; presentation `daily_edge_member_presentation_2026_08_29_r20_cfb_concise_member_read`. The existing forward-evidence writer remains the sole writer under `prediction_pipeline:cfb` and makes one atomic append only after all covered-game coherence gates pass.
- Member presentation r20 removes release mechanics and repeated methodology qualifiers from the visible CFB Quick Read. The customer surface now presents the expected score, representative final, outcome probabilities, compact football baseline, exact sportsbook contract, model/market gap, computed exact-price EV, actionability, and one Bet grade. The underlying market/sharp PMF, probabilities, predictions, grades, immutable rows, locks, tracking, provider provenance, and audit records are unchanged. Pending sharp evidence renders only as `Sharp Splits · Pending · No verified split yet`; provider names and internal collection explanations remain private. Roll back presentation to r19 without changing any prediction release.
...
- Transition and rollback: r13/r22/r17 becomes readable only as one complete release wave, except that an exact genuinely valid immutable T-60/started row from r12/r21/r16 authority may be carried with its original releases and values. A held legacy T-60 does not satisfy the active release lock boundary; once the active release writes its own held row it remains terminal for that release, preventing duplicate append attempts. A valid prior lock remains frozen. Reader-only same-book trails may use earlier immutable release rows with explicit timestamps and book identity, while model results and tracking remain release-separated. TCU-UNC started without a valid r12 lock and is not retroactively backfilled or called on-time. Official tracking accepts only exact r13/r22/r17/r5 T-60 payloads. Mixed releases, incoherence, missing price coverage, a crash, failed future T-60 creation, or another actionable collapse triggers hold/rollback to r12/r21/r16. Evidence: `docs/model-audits/2026-08-29-cfb-market-sharp-authoritative-r41.md` and `docs/model-audits/2026-08-29-cfb-transition-actionable-stabilization-r42.md`.
