...
- Writer and provider boundary: evidence schema / collector / member / writer are `cfb_forward_evidence_snapshot_2026_08_25_r1` / `cfb_forward_evidence_collector_2026_08_25_r1` / `cfb_v1_member_release_2026_08_25_r1` / `cfb_forward_evidence_writer_2026_08_25_r1`. One scheduled writer owns the `prediction_pipeline:cfb` lease and captures immutable Opening/T-60 evidence plus bounded unlocked refreshes. BALLDONTLIE supplies the authoritative slate, named-book prices, active rosters, and previous-season QB passing context. Playbook public consensus is labeled separately. Strict SharpAPI NCAAF splits, timestamped injuries, confirmed depth/starters, and venue weather are currently unavailable and are never fabricated.
