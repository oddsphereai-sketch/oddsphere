...
- Evidence: `docs/model-audits/2026-08-22-nfl-week1-evidence-board-r1.md`, `docs/model-audits/2026-08-22-nfl-multibook-forward-evidence-r2.md`, and `docs/model-audits/2026-08-22-nfl-r6-shadow-writer.md`. This remains an honest evidence/forward-evaluation state, not a public r6 approval. Predictive and decision-policy research remains blocked from promotion until timestamp-valid T-60, CLV, settlement, QB confirmation, and explicit owner approval gates pass.
