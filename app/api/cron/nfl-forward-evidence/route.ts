  ...
  return cronHandler(request, "nfl_forward_evidence", async ({ runId }) => {
    ...
    return {
      ...
      details: {
        ...
        shadow_evaluations: result.shadowEvaluations,
        shadow_leans: result.shadowLeans,
        shadow_held: result.shadowHeld,
        shadow_blocking_reasons: result.shadowBlockingReasons,
