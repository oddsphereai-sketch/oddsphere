...
export type DailyEdgeGameDto = {
  ...
  soccerProjection?: {
    /** Score distribution generated by the same club-only head that supplies
     * the released Match Result probabilities. Moneyline readers must use
     * this context instead of the separate market-informed goals head. */
    matchResultOutlook?: {
