...
check(
  "grade policy carries July 25 v8 writer-reader decision coherence version",
  layers.grade_policy === "mlb_public_grade_policy_v8_writer_reader_decision_coherence_2026_07_25",
);
check(
