...
check(
  "MLB FI probable-pitcher tracking coherence is versioned as decision release r28",
  MLB_DAILY_EDGE_DECISION_RELEASE_ID === "mlb_daily_edge_decision_2026_08_11_r28" &&
