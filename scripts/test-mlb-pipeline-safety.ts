...
check(
  "grade policy carries July 27 v11 model-first additive-rule version",
  layers.grade_policy === "mlb_public_grade_policy_v11_model_first_additive_rules_2026_07_27",
);
check(
