...
check(
  "grade policy carries August 13 v29 totals replacement policy",
  layers.grade_policy === "mlb_public_grade_policy_v29_total_mean_selector_under_replacement_2026_08_13",
);
check(
...
check(
  "MLB totals replacement policy is versioned as decision release r39",
  MLB_DAILY_EDGE_DECISION_RELEASE_ID === "mlb_daily_edge_decision_2026_08_13_r39" &&
