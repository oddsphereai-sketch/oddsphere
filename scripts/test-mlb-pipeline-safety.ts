...
check(
  "MLB rejected-total-correction original-side validation is versioned as decision release r29",
  MLB_DAILY_EDGE_DECISION_RELEASE_ID === "mlb_daily_edge_decision_2026_08_11_r29" &&
