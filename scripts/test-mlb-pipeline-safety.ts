...
check(
  "grade policy carries August 11 v24 SharpAPI total-source alignment",
  layers.grade_policy === "mlb_public_grade_policy_v24_sharpapi_total_source_alignment_2026_08_11",
);
check(
...
check(
  "MLB SharpAPI total-source alignment is versioned as decision release r33",
  MLB_DAILY_EDGE_DECISION_RELEASE_ID === "mlb_daily_edge_decision_2026_08_11_r33" &&
