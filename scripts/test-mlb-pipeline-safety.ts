...
check(
  "grade policy carries the r71 verified split-evidence hierarchy",
  layers.grade_policy === "mlb_public_grade_policy_v49_verified_split_evidence_2026_08_28",
);
check(
...
check(
  "MLB r71 versions verified split evidence without changing champion heads or correction policy",
  MLB_DAILY_EDGE_DECISION_RELEASE_ID === "mlb_daily_edge_decision_2026_08_28_r71_verified_split_evidence" &&
    MLB_MODEL_LAYER_VERSION_SCHEMA === "mlb_model_layer_versions_v5" &&
    layers.rule_bundle_version === "mlb_daily_edge_rule_bundle_v59_verified_split_evidence_2026_08_28" &&
