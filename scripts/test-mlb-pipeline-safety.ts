...
check(
  "grade policy carries August 14 v33 complete SharpAPI event discovery policy",
  layers.grade_policy === "mlb_public_grade_policy_v33_complete_sharpapi_event_discovery_2026_08_14",
);
check(
...
check(
  "MLB complete SharpAPI event discovery is versioned as decision release r43",
  MLB_DAILY_EDGE_DECISION_RELEASE_ID === "mlb_daily_edge_decision_2026_08_14_r43" &&
