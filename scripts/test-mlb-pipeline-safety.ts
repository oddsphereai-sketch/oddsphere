...
check(
  "grade policy carries August 14 v32 all-writer sharp-slate-identity policy",
  layers.grade_policy === "mlb_public_grade_policy_v32_all_writer_sharp_slate_identity_2026_08_14",
);
check(
...
check(
  "MLB all-writer sharp-slate identity policy is versioned as decision release r42",
  MLB_DAILY_EDGE_DECISION_RELEASE_ID === "mlb_daily_edge_decision_2026_08_14_r42" &&
