...
check(
  "grade policy carries July 25 v9 official starter-confirmation version",
  layers.grade_policy === "mlb_public_grade_policy_v9_official_starter_confirmation_2026_07_25",
);
check(
