...
async function main() {
  ...
  check("drawer exposes contradictions only as blocked diagnostics", drawerSource.includes("ProjectionIntegrityNotice") && drawerSource.includes("Blocked projection-side contradiction") && drawerSource.includes("excluded from positive model signals"));
