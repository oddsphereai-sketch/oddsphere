...
async function main() {
  ...
  check("best-price board pairs both sides and identifies the model lean", propsUiSource.includes("MarketPairCards") && propsUiSource.includes("modelLeanSide") && propsUiSource.includes("Model lean:") && propsUiSource.includes(">Model lean<") && propsUiSource.includes("Not offered") && !propsUiSource.includes("Not posted"));
