...
async function main() {
  ...
  check("best-price board pairs both sides and separates prediction from play grade", propsUiSource.includes("MarketPairCards") && propsUiSource.includes("modelPrediction(pair)") && propsUiSource.includes("ModelPredictionBadge") && propsUiSource.includes("isPredictionSide") && propsUiSource.includes("Prediction") && propsUiSource.includes("Not offered") && !propsUiSource.includes("Projection side") && !propsUiSource.includes("Model side:"));
