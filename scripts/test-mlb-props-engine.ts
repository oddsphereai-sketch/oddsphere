...
async function main() {
  ...
  check("best-price board pairs both sides and identifies the projection side", propsUiSource.includes("MarketPairCards") && propsUiSource.includes("modelLeanSide") && propsUiSource.includes("Projection side:") && propsUiSource.includes(">Projection side<") && propsUiSource.includes("Research only") && propsUiSource.includes("Not offered") && !propsUiSource.includes("Not posted"));
  ...
  check("grade helpers use Daily Edge-aligned member labels", getPropGradeLabel("BEST_ANGLE") === "Best Angle" && getPropGradeLabel("LEAN") === "Lean" && getPropGradeLabel("WATCHLIST") === "Watchlist" && getPropGradeLabel("NO_PLAY") === "No Edge" && getPropGradeDescription("BEST_ANGLE").length > 0);
