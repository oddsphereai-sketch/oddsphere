...
async function main() {
  ...
  check("pitcher best angles require a material model projection cushion", liveBoardSource.includes("function pitcherSignalGrade") && liveBoardSource.includes('args.market === "pitcher_outs" ? 1') && liveBoardSource.includes('args.market === "pitcher_strikeouts" ? 0.35') && liveBoardSource.includes("scoredPitcherSignal?.modelProjection ?? projection"));
