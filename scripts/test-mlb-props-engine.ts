...
async function main() {
  ...
  check("home run longshot watches surface above the board", propsUiSource.includes("function LongshotWatchStrip") && propsUiSource.includes("Longshot Watch") && propsUiSource.includes("Home run price reads") && propsUiSource.includes('marketFilter !== "batter_home_runs"') && propsUiSource.includes("longshotWatchRows={longshotWatchRows}"));
