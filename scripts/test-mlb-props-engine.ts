...
async function main() {
  ...
  check("prediction badges use the same final estimate shown in the reader", propsUiSource.includes("probability: signalPrediction.finalProbability ?? signalPrediction.modelProbability") && propsUiSource.includes("return row.finalProbability ?? row.modelProbability"));
