/**
 * SELECT-only replay of the MLB props r39 target-excluded forecast candidate.
...
async function main(): Promise<void> {
  if (MLB_PROPS_MODEL_RELEASE_ID !== "mlb_props_2026_09_02_r39") {
  ...
  const report = {
    auditRelease: "mlb_props_target_excluded_forecast_audit_2026_09_02_r1",
    candidateRelease: MLB_PROPS_MODEL_RELEASE_ID,
    readOnly: true,
    databaseSelects: 2,
    providerCalls: 0,
    ...
    limitations: {
      ...
      exactProductionImpactRequiresNaturalR39Writer: true,
