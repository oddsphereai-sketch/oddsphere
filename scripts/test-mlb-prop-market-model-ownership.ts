...
assert.equal(versions.batter_home_runs, `${BATTER_HOME_RUNS_RESIDUAL_MODEL_VERSION}_actionability_v3_three_play_lean_portfolio`);
...
assert.equal(MLB_PROPS_MODEL_RELEASE_ID, "mlb_props_2026_08_13_r33");
