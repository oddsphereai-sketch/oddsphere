...
assert.equal(versions.batter_home_runs, "batter_home_runs_rare_event_integrated_read_v2_top5_actionable");
assert.equal(MLB_PROPS_MODEL_RELEASE_ID, "mlb_props_2026_07_22_r2");
