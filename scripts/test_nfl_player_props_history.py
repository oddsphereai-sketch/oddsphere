...
features, columns = module.add_player_prior_features(rows, ["passing_yards"])
...
changed_features, _ = module.add_player_prior_features(changed, ["passing_yards"])
cols = ["player_id", "week", "prior_passing_yards_lag1", "prior_passing_yards_avg3"]
