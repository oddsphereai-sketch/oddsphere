...
check(
  "WNBA unlocked readers reuse only a compatible last-known-good v5 tuple",
  wnbaAdapterSource.includes("record.snapshot_json?.prediction_record_contract_version !== WNBA_V5_RECORD_CONTRACT_VERSION") &&
